...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.9\linewidth]{../figures/stratified_etth1.pdf}
\end{center}
\caption{MSE stratified by predictability quartile on ETTh1 ($H=96$). SSMs excel in high-predictability regimes (Q4) but degrade faster than baselines under low predictability (Q1).}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.9\linewidth]{../figures/decomposition.pdf}
\end{center}
\caption{Forecast error decomposition. SSMs show higher structural error relative to their total, suggesting capacity misallocation that \pwt{} addresses.}
...
\begin{itemize}
    \item \textbf{S4 + \pwt{}}: -2.0\% average MSE reduction across all horizons and datasets, with the largest single improvement of 18\% on ETTh2 at $H=720$.
    \item \textbf{Mamba + \pwt{}}: Mixed results across horizons---improvements of up to 7.4\% on some configurations, with the framework providing the clearest benefits at longer prediction horizons where structural error dominates.
    \item \textbf{PatchTST + \pwt{}}: -3.1\% average MSE reduction, demonstrating that the framework generalizes beyond SSMs to Transformer architectures.
\end{itemize}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.9\linewidth]{../figures/pwt_ablation.pdf}
\end{center}
\caption{Effect of \pwt{} on SSMs across datasets ($H=96$). Consistent improvements, with larger gains on mixed-predictability datasets.}
\label{fig:pwt}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.9\linewidth]{../figures/horizon_etth1.pdf}
\end{center}
\caption{MSE vs.\ prediction horizon on ETTh1. \pwt{} benefits grow at longer horizons.}
\label{fig:horizon}
\end{figure}
